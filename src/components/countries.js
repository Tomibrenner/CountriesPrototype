          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-8">
            ...
            >
              <input
                ...
                className="py-3 px-4 text-gray-600 placeholder-gray-600 w-full shadow rounded outline-none dark:placeholder-grey-600 dark:bg-gray-800 dark:focus:bg-gray-700 transition-all duration-200"
              />
            </form>
            <form onSubmit={handleFilterByRegion}>
              <select
                ...
                id="filter-by-region"
                className="w-52 py-3 px-4 outline-none shadow rounded text-gray-600 dark:bg-gray-800 dark:focus:bg-gray-700 "
                value={regions.name}
